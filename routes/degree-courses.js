...
router.post('/:majorID/courses', [authenticate, isAdminOrAdvisor], function(req, res, next) {
...
router.delete('/:majorID/courses/:courseNo', [authenticate, isAdminOrAdvisor], function(req, res, next) {
